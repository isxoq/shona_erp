...
//        WorkTimes::deleteAll();
    ...
    public function actionClient()
    {
        ...
        for ($i = 1; $i <= 100; $i++) {
            ...
            $model = new Clients();
            $model->full_name = $factory->firstName . " " . $factory->lastName;
            $model->phone = Phone::clear($this->generateUzbPhone());
            $model->address = $factory->address;
    ...
    public function actionProduct()
    {
        ...
        for ($i = 1; $i <= 100; $i++) {
            ...
            $model->price_usd = $factory->numberBetween(10, 100);
