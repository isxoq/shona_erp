...
$menuItems = [
    ...
    ['label' => "Harajat qilish", 'url' => ['/expenses/create'], 'icon' => 'tasks', "visible" => Yii::$app->user->identity->checkRoles(["admin", "Administrator", "Rahbar"])],
//    ['label' => "Shona Kredit yaratish", 'url' => ['/orders/create-credit'], 'icon' => 'list', "visible" => Yii::$app->user->identity->checkRoles(["admin", "Rahbar", "Operator", "Diller"])],
    ...
    ['label' => "Ombor", 'icon' => 'download', "items" => [
        ['label' => "Asosiy Ombor", 'url' => ['/store'], 'icon' => 'store', "visible" => Yii::$app->user->identity->checkRoles(["admin", "Administrator", "Rahbar"])],
