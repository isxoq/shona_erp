...
//    ['label' => "Maosh va bonus", 'url' => ['/salary'], 'icon' => 'list',],
    ...
    ['label' => "Oylik maosh", 'url' => ['/staff/salary'], 'icon' => 'list', "visible" => !Yii::$app->user->identity->checkRoles(["admin", "Rahbar"])],
    ['label' => "Oylik maosh", 'url' => ['/staff/total-salary'], 'icon' => 'list', "visible" => Yii::$app->user->identity->checkRoles(["admin", "Rahbar"])],
